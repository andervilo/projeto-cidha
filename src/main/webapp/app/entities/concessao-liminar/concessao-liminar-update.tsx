...
import { getEntity, updateEntity, createEntity, setBlob, reset } from './concessao-liminar.reducer';
...
export const ConcessaoLiminarUpdate = (props: IConcessaoLiminarUpdateProps) => {
  ...
  const { concessaoLiminarEntity, loading, updating } = props;

  const { descricao } = concessaoLiminarEntity;
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : concessaoLiminarEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="concessao-liminar-descricao" type="textarea" name="descricao" />
              </AvGroup>
